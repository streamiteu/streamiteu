			...
			<div class="center-sign">
				...
				<div class="panel panel-sign">
					<div class="panel-title-sign mt-xl text-right">
						<h2 class="title text-uppercase text-bold m-none"><i class="fa fa-user mr-xs"></i> Registration info</h2>
					</div>
					<div class="panel-body">
						<div class="alert alert-info">
							<p class="m-none text-semibold h6">Thank you for registering! Please wait for approval of your account by authorized person, so you can login.</p>
						</div>
					</div>
				</div>
