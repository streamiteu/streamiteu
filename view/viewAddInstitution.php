...
?>
					<div class="row">
						<div class="col-md-12">
							<form id="insertinstitution-form" method="post">
								<section class="panel">
									...
									<div class="panel-body">
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" name="institution_name" class="form-control" value="" placeholder="eg.: Museum of art" required/>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-9">
												<select id="country-institution-admin" name="country-institution-admin" class="form-control input-sm mb-md" required>
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="checkbox" id="approved" name="approved" value="">
											</div>
										</div>
