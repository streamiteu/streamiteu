...
<html class="fixed">
	...
	<body>
					...
					<div class="panel-body">
						<div class="validation-message" style="display: none;">
							<ul style="display: block;">
								<li>
								<label id="error_message" class="error" style="display: inline-block;">Plase enter a name.</label>
								</li>
							</ul>
						</div>
						<div class="info-message" style="display: none;">
							<ul style="display: block;">
								<li>
								<label id="info_message" class="info" style="display: inline-block;">Plase enter a name.</label>
								</li>
							</ul>
						</div>
						<form method="POST" id="user_registration">
							<div class="form-group mb-sm">
								<label>Please select account type <span class="required">*</span></label>
								<div>
									<label class="radio-inline">
										<input type="radio" name="accounttype" id="accounttype1" value="personal" required>Personal 
									</label>
									<div class="tooltip">
										<i class="fa fa-question-circle mr-xs" style="font-size: 17px; color: #0088cc; cursor: pointer; margin-left: 10px; z-index: 0; position: relative;"></i>
										<div class="right">
											<h3>Personal account</h3>
											<p>If you are teacher or tour guide choose this option. You can apply for personal account if your institution is already registered.</p>
											<i></i>
										</div>
									</div>
									<label class="radio-inline" style="margin-left: 30px">
										<input type="radio" name="accounttype" id="accounttype2" value="institution" required>Institutional
									</label>
									<div class="tooltip">
										<i class="fa fa-question-circle mr-xs" style="font-size: 17px; color: #0088cc; cursor: pointer; margin-left: 10px; z-index: 0; position: relative;"></i>
										<div class="right">
											<h3>Institutional account</h3>
											<p>If you are school or museum manager, you can register your institution in the system by choosing this option.</p>
											<i></i>
										</div>
									</div>
								</div>
							...
							<div class="form-group mb-sm">
								<select id="institutiontype" class="form-control input-sm mb-md" required>
									<option value="">Institution type (museum/school)</option>
							...
							<div id="institution_container" class="form-group mb-sm">
								<label>Institution name <span class="required">*</span></label>
								<div id="institution_placeholder" class="institution_placeholder">
									<input name="institution" type="text" class="form-control input-sm mb-md" placeholder="Enter institution name" required/>
								</div>
							</div>
							<div id="container_data">
								<div class="form-group mb-sb">
									<label id="data_details">Personal details</label>
									<div class="row">
										<div class="col-sm-6 mb-none">
											<label>First name <span class="required">*</span></label>
											<input name="firstname" type="text" class="form-control input-sm mb-none" placeholder="Enter first name" required />
										</div>
										<div class="col-sm-6 mb-none">
											<label>Last name <span class="required">*</span></label>
											<input name="lastname" type="text" class="form-control input-sm mb-none" placeholder="Enter lsst name" required />
										</div>
									</div>
								</div>
								<div class="form-group mb-sb">
									<label>E-mail Address <span class="required">*</span></label>
									<input name="email" type="email" class="form-control input-sm mb-md" required />
								</div>
								<div class="form-group mb-sb">
									<div class="row">
										<div class="col-sm-6 mb-none">
											<label>Password <span class="required">*</span></label>
											<input name="pwd" type="password" class="form-control input-sm mb-none" required />
										</div>
										<div class="col-sm-6 mb-none">
											<label>Password Confirmation <span class="required">*</span></label>
											<input name="pwd_confirm" type="password" class="form-control input-sm mb-none" required />
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-sm-8">
										<div class="checkbox-custom checkbox-default">
											...
											<label for="AgreeTerms">I agree with <a id="modalbtn" href="#">terms of use</a></label>
										</div>
									</div>
							...
							<span class="mt-sb mb-sb line-thru text-center text-uppercase">
								<span>or</span>
							</span>
		...
		<!-- The Modal -->
		<div id="streamitModal" class="modal">
		  ...
		  <div class="modal-content">
			...
			<div class="modal-body">
			  <div id="policy-template-html" class="scroll">

				<p><strong>AGREEMENT TO TERMS</strong></p>
				<p>These Terms and Conditions constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and<span style="color: #8351f9;"> [business entity name]</span> (“we,” “us” or “our”), concerning your access to and use of the <span style="color: #8351f9;">[website name.com]</span> website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”).</p>
				...
				<p>These terms and conditions were created by Termly’s <a href="https://termly.io/products/terms-and-conditions-generator/">Terms and Conditions Generator</a>.</p>
				<p><span style="color: #8351f9;"><strong>Option 1</strong></span>: The Site is intended for users who are at least 18 years old. Persons under the age of 18 are not permitted to register for the Site.</p>
				<p><span style="color: #8351f9;"><strong>Option 2</strong>: [The Site is intended for users who are at least 13 years of age.]</span> All users who are minors in the jurisdiction in which they reside (generally under the age of 18) must have the permission of, and be directly supervised by, their parent or guardian to use the Site. If you are a minor, you must have your parent or guardian read and agree to these Terms and Conditions prior to you using the Site.</p>
				...
				<p><span style="color: #8351f9;">[(1) all registration information you submit will be true, accurate, current, and complete; (2) you will maintain the accuracy of such information and promptly update such registration information as necessary;]</span></p>
				...
				<p>(5) not a minor in the jurisdiction in which you reside <span style="color: #8351f9;">[, or if a minor, you have received parental permission to use the Site]</span>;</p>
				...
				<p><span style="color: #8351f9;">[As an advertiser, you agree that such advertisements are subject to our Digital Millennium Copyright Act (“DMCA”) Notice and Policy provisions as described below, and you understand and agree there will be no refund or other compensation for DMCA takedown-related issues.]</span> We simply provide the space to place such advertisements, and we have no other relationship with advertisers.</p>
				...
				<p>We care about data privacy and security. Please review our Privacy Policy <span style="color: #8351f9;">[CLICK HERE]/posted on the Site]</span>. By using the Site, you agree to be bound by our Privacy Policy, which is incorporated into these Terms and Conditions. Please be advised the Site is hosted in the United States.</p>
				...
				<p>If you believe your own copyrighted material has been removed from the Site as a result of a mistake or misidentification, you may submit a written counter notification to <span style="color: #8351f9;">[us/our Designated Copyright Agent] </span>using the contact information provided below (a “Counter Notification”).</p>
				...
				<p>Please be advised that pursuant to federal law you may be held liable for damages if you make material misrepresentations in a Notification. Thus, if you are not sure that material located on or linked to by the Site infringes your copyright, you should consider first contacting an attorney.]
				</p><p><strong>TERM AND TERMINATION</strong></p>
				<p>These Terms and Conditions shall remain in full force and effect while you use the Site. WITHOUT LIMITING ANY OTHER PROVISION OF THESE TERMS AND CONDITIONS, WE RESERVE THE RIGHT TO, IN OUR SOLE DISCRETION AND WITHOUT NOTICE OR LIABILITY, DENY ACCESS TO AND USE OF THE SITE (INCLUDING BLOCKING CERTAIN IP ADDRESSES), TO ANY PERSON FOR ANY REASON OR FOR NO REASON, INCLUDING WITHOUT LIMITATION FOR BREACH OF ANY REPRESENTATION, WARRANTY, OR COVENANT CONTAINED IN THESE TERMS AND CONDITIONS OR OF ANY APPLICABLE LAW OR REGULATION. WE MAY TERMINATE YOUR USE OR PARTICIPATION IN THE SITE OR DELETE <span style="color: #8351f9;">[YOUR ACCOUNT AND]</span> ANY CONTENT OR INFORMATION THAT YOU POSTED AT ANY TIME, WITHOUT WARNING, IN OUR SOLE DISCRETION.</p>
				...
				<p>These Terms and Conditions and your use of the Site are governed by and construed in accordance with the laws of the State of <span style="color: #8351f9;">[name of state]</span> applicable to agreements made and to be entirely performed within the State/Commonwealth of <span style="color: #8351f9;">[name of state]</span>, without regard to its conflict of law principles.</p>
				<p><strong>DISPUTE RESOLUTION</strong></p>
				<p><strong>Option 1</strong>: Any legal action of whatever nature brought by either you or us (collectively, the “Parties” and individually, a “Party”) shall be commenced or prosecuted in the state and federal courts located in<span style="color: #8351f9;"> [name of county]</span> County, <span style="color: #8351f9;">[name of state]</span>, and the Parties hereby consent to, and waive all defenses of lack of personal jurisdiction and forum non conveniens with respect to venue and jurisdiction in such state and federal courts.</p>
				<p>Application of the United Nations Convention on Contracts for the International Sale of Goods and the Uniform Computer Information Transaction Act (UCITA) are excluded from these Terms and Conditions. In no event shall any claim, action, or proceeding brought by either Party related in any way to the Site be commenced more than<span style="color: #8351f9;"> ______</span> years after the cause of action arose.</p>
				<p><strong>Option 2: Informal Negotiations</strong></p>
				<p>To expedite resolution and control the cost of any dispute, controversy, or claim related to these Terms and Conditions (each a “Dispute” and collectively, the “Disputes”) brought by either you or us (individually, a “Party” and collectively, the “Parties”), the Parties agree to first attempt to negotiate any Dispute (except those Disputes expressly provided below) informally for at least <span style="color: #8351f9;">______</span> days before initiating arbitration. Such informal negotiations commence upon written notice from one Party to the other Party.</p>
				...
				<p>Your arbitration fees and your share of arbitrator compensation shall be governed by the AAA Consumer Rules and, where appropriate, limited by the AAA Consumer Rules. <span style="color: #8351f9;">[If such costs are determined by the arbitrator to be excessive, we will pay all arbitration fees and expenses.]</span></p>
				...
				<p>The arbitrator must follow applicable law, and any award may be challenged if the arbitrator fails to do so. Except where otherwise required by the applicable AAA rules or applicable law, the arbitration will take place in <span style="color: #008000;"><span style="color: #8351f9;">[name of county]</span> </span>County, <span style="color: #8351f9;">[name of state]</span>.</p>
				...
				<p>If for any reason, a Dispute proceeds in court rather than arbitration, the Dispute shall be commenced or prosecuted in the state and federal courts located in <span style="color: #8351f9;">[name of county]</span> County, <span style="color: #8351f9;">[name of state]</span>, and the Parties hereby consent to, and waive all defenses of lack of personal jurisdiction, and forum non conveniens with respect to venue and jurisdiction in such state and federal courts.</p>
				...
				<p>In no event shall any Dispute brought by either Party related in any way to the Site be commenced more than <span style="color: #8351f9;">_____</span> years after the cause of action arose. If this provision is found to be illegal or unenforceable, then neither Party will elect to arbitrate any Dispute falling within that portion of this provision found to be illegal or unenforceable and such Dispute shall be decided by a court of competent jurisdiction within the courts listed for jurisdiction above, and the Parties agree to submit to the personal jurisdiction of that court.</p>
				...
				<p>Your arbitration fees and your share of arbitrator compensation shall be governed by the AAA Consumer Rules and, where appropriate, limited by the AAA Consumer Rules. <span style="color: #8351f9;">[If such costs are determined to by the arbitrator to be excessive, we will pay all arbitration fees and expenses.]</span></p>
				...
				<p>Except where otherwise required by the applicable AAA rules or applicable law, the arbitration will take place in <span style="color: #8351f9;">[name of county]</span> County, <span style="color: #8351f9;">[name of state]</span>. Except as otherwise provided herein, the Parties may litigate in court to compel arbitration, stay proceedings pending arbitration, or to confirm, modify, vacate, or enter judgment on the award entered by the arbitrator.</p>
				<p>If for any reason, a Dispute proceeds in court rather than arbitration, the Dispute shall be commenced or prosecuted in the state and federal courts located in<span style="color: #8351f9;"> [name of county]</span> County, <span style="color: #8351f9;">[name of state]</span>, and the Parties hereby consent to, and waive all defenses of lack of, personal jurisdiction, and forum non conveniens with respect to venue and jurisdiction in such state and federal courts.</p>
				<p>Application of the United Nations Convention on Contracts for the International Sale of Goods and the Uniform Computer Information Transaction Act (UCITA) are excluded from these Terms and Conditions. In no event shall any Dispute brought by either Party related in any way to the Site or Services be commenced more than <span style="color: #8351f9;">______</span> years after the cause of action arose.</p>
				...
				<p><strong>Option 2/Option 3: Exceptions to <span style="color: #8351f9;">[Informal Negotiations and]</span> Arbitration</strong></p>
				<p>The Parties agree that the following Disputes are not subject to the above provisions concerning <span style="color: #8351f9;">[informal negotiations and]</span> binding arbitration: (a) any Disputes seeking to enforce or protect, or concerning the validity of, any of the intellectual property rights of a Party; (b) any Dispute related to, or arising from, allegations of theft, piracy, invasion of privacy, or unauthorized use; and (c) any claim for injunctive relief.</p>
				<p>If this provision is found to be illegal or unenforceable, then neither Party will elect to arbitrate any Dispute falling within that portion of this provision found to be illegal or unenforceable and such Dispute shall be decided by a court of competent jurisdiction within the courts listed for jurisdiction above, and the Parties agree to submit to the personal jurisdiction of that court.</p>
				...
				<p><span style="color: #8351f9;">[NOTWITHSTANDING ANYTHING TO THE CONTRARY CONTAINED HEREIN, OUR LIABILITY TO YOU FOR ANY CAUSE WHATSOEVER AND REGARDLESS OF THE FORM OF THE ACTION, WILL AT ALL TIMES BE LIMITED TO [THE LESSER OF] [THE AMOUNT PAID, IF ANY, BY YOU TO US DURING THE [_________] MONTH PERIOD PRIOR TO ANY CAUSE OF ACTION ARISING [OR] [$_________]. CERTAIN STATE LAWS DO NOT ALLOW LIMITATIONS ON IMPLIED WARRANTIES OR THE EXCLUSION OR LIMITATION OF CERTAIN DAMAGES.</span></p>
				<p><span style="color: #8351f9;">IF THESE LAWS APPLY TO YOU, SOME OR ALL OF THE ABOVE DISCLAIMERS OR LIMITATIONS MAY NOT APPLY TO YOU, AND YOU MAY HAVE ADDITIONAL RIGHTS.]</span></p>
				<p><strong>INDEMNIFICATION</strong></p>
				<p>You agree to defend, indemnify, and hold us harmless, including our subsidiaries, affiliates, and all of our respective officers, agents, partners, and employees, from and against any loss, damage, liability, claim, or demand, including reasonable attorneys’ fees and expenses, made by any third party due to or arising out of: (1) <span style="color: #8351f9;">[your Contributions]</span>; (2) use of the Site; (3) breach of these Terms and Conditions; (4) any breach of your representations and warranties set forth in these Terms and Conditions; (5) your violation of the rights of a third party, including but not limited to intellectual property rights; or (6) any overt harmful act toward any other user of the Site with whom you connected via the Site.</p>
		...
		<script>
		// Get the modal
		var modal = document.getElementById("streamitModal");
